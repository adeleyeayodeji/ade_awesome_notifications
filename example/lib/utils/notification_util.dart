...
Future<void> showBasicNotification2(int id) async {
  String channelKey = 'importance_Max_channel';
  String title = 'This is important';
  String body = 'Test of importance levels';
